...
class _DomiclioOTiendaOpcionesState extends State<DomiclioOTiendaOpciones> {
  ...
  @override
  void initState() {GetUserInfo().getUserInfo().then((value)
  ...
  Widget build(BuildContext context) {
    ...
    return userModel==null || turnSplash== true ? SplashScreen()
        :Scaffold(
            body: SafeArea(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            UsedWidgets().buildTextFormWidgetForPhone(
                              ...
                              onChanged: (value) {setState(() {valueFixedPhone = value!;});},), SizedBox(height: 20,),
                      ...
                      Container(
                        ...
                        height: 60, child: Padding(
                          ...
                          child: ElevatedButton(onPressed: () async {
                              ...
                              //values to be sent : listOfCartModel, valueManeraEntrega,valueManeraPago,grandTotal,grandTotalbase,grandTotalTaxes,grandTotalDiscount
